...
namespace Microsoft.Authentication.MSALWrapper.Test
{
    ...
    internal class DeviceCodeTest
    {
        ...
        private string cacheFileName = $"msal_{TenantId}.cache";
        ...
        public void Setup()
        {
            ...
            this.serviceProvider = new ServiceCollection()
             ...
             .AddTransient<AuthFlow.DeviceCode>((provider) =>
             {
                 ...
                 return new AuthFlow.DeviceCode(logger, ClientId, TenantId, this.scopes, this.cacheFileName, pcaWrapper: this.pcaWrapperMock.Object, promptHint: this.promptHint);
             })
