...
[![Release](https://img.shields.io/badge/Release-0.8.1-orange?style=for-the-badge&logo=github)](https://github.com/AzureAD/microsoft-authentication-cli/releases/tag/0.8.1)
![GitHub release (latest by SemVer)](https://img.shields.io/github/downloads/azuread/microsoft-authentication-cli/0.8.1/total?logo=github&style=for-the-badge&color=blue)
...
```powershell
# 0.8.1 is an example. See https://github.com/AzureAD/microsoft-authentication-cli/releases for the latest.
$env:AZUREAUTH_VERSION = '0.8.1'
...
```bash
# 0.8.1 is an example. See https://github.com/AzureAD/microsoft-authentication-cli/releases for the latest.
export AZUREAUTH_VERSION='0.8.1'
